...
<?php if ( ! is_user_logged_in() ) : ?>
	...
	<form id="rcp_login_form"  class="<?php echo esc_attr( $rcp_login_form_args['class'] ); ?>" method="POST" action="<?php echo esc_url( rcp_get_current_url() ); ?>">
		...
		<fieldset class="rcp_login_data">
			...
			<p class="rcp-form_button--container">
				...
				<input id="rcp_login_submit" class="rcp-button rcp-form_button" type="submit" value="<?php esc_attr_e( 'Login', 'rcp' ); ?>"/>
			</p>
...
<?php else : ?>
	<div class="rcp_logged_in text-center">
		<h2>You're already logged in</h2>
		</h2>
		<a class="rcp-form-logout" href="<?php echo wp_logout_url( home_url() ); ?>"><?php _e( 'Log out', 'rcp' ); ?></a>
	</div>
<?php endif; ?>
